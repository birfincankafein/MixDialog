...
[![Release](https://img.shields.io/badge/release-1.1.0-blue.svg?style=flat)](https://bintray.com/birfincankafein/com.birfincankafein/mixdialog/_latestVersion)  [![API](https://img.shields.io/badge/API-14+-green.svg?style=flat)]()
...
**1. Gradle dependency**  
 ...
 ```gradle  
dependencies {  
    implementation 'com.birfincankafein:mixdialog:1.1.0@aar'
}  
```  
...
```xml  
<dependency org='com.birfincankafein' name='mixdialog' rev='1.1.0'> <artifact name='mixdialog' ext='pom' /> </dependency>
```  
